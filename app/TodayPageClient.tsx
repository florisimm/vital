...
// Seeds the SWR cache with server-fetched data so the first client paint already
// shows the correct dashboard (no blank → content flash). Falls back to an empty
// map for logged-out visitors, where HomePage renders the landing page instead.
export function TodayPageClient({ fallback }: { fallback: Record<string, unknown> }) {
  return (
